...
namespace Hardware {
  ...
  [[deprecated("Use eom_hal_get_device_serial()")]] String getDeviceSerial() {
    char serial[40] = "";
  ...
  [[deprecated("Use eom_hal_set_sensor_sensitivity()")]] void setPressureSensitivity(byte value) {
    eom_hal_set_sensor_sensitivity(value);
  }

  [[deprecated("Use eom_hal_get_sensor_sensitivity()")]] byte getPressureSensitivity() {
