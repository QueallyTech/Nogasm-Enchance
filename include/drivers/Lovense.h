...
public:
    Lovense(const char *name, NimBLEClient *client, NimBLERemoteCharacteristic *rxChar, NimBLERemoteCharacteristic *txChar) : Device(name, client), rxChar(rxChar), txChar(txChar){};
